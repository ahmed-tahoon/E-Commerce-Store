...
import { loginadminUser } from "../../Containers/Admin/loginAdminSlice";
...
await dispatch(loginadminUser(data)).then((res) => {
      if (res.error) {
...
localStorage.setItem('adminInfo',JSON.stringify(res.payload));
if(!loading)
{
 console.log(history)
